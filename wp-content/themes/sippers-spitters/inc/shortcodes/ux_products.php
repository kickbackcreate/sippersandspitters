<?php
//added woocommerce_shop_loop_item_title_SS to align brand and product name BUT this file doesnt update the theme.... change is in same file in flatsome theme - replace if ever removed by update!!!
